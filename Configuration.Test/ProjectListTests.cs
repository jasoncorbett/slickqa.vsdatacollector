...
namespace SlickQA.DataCollector.Configuration.Test
{
	...
	public class ProjectListTests
	{
		...
		public void GetTestList()
		{
			...
			var project2Stream = ConvertStringToStream(PROJECT_2);
			var project1 = StreamConverter<Project>.ReadFromStream(project1Stream);
			var project2 = StreamConverter<Project>.ReadFromStream(project2Stream);
			...
			mockView.Setup(view => view.PopulateProjects(It.IsAny<IEnumerable<Project>>()))
				.Callback<IEnumerable<Project>>(
				list => projects = list);
		...
		[TestMethod]
		public void ViewPassesClickOnToController()
		{
