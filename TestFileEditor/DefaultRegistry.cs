...
namespace SlickQA.TestFileEditor
{
	public sealed class DefaultRegistry : Registry
	{
		public DefaultRegistry()
		{
			...
			SetAllProperties(x =>
			{
				x.OfType<ResultDestinationController>();
				x.OfType<BuildSpecifierController>();
				x.OfType<ChooseBuildProviderController>();
				x.OfType<ExecutionNamingController>();
				x.OfType<NewProjectController>();
				x.OfType<NewReleaseController>();
				x.OfType<NewTestPlanController>();
				x.OfType<UrlController>();
			}
			);
