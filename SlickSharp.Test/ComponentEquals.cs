...
{
	[TestClass]
	public sealed class ComponentEquals
	{
		// ReSharper disable SuspiciousTypeConversion.Global
		// ReSharper disable ConvertToConstant.Local
		[TestMethod]
		public void Is_false_for_non_component_objects()
		{
			var b = new Component { Id = "1234567890" };
		...
		{
			var item = new Component { Id = "1234567890" };
			var item2 = new Component { Id = "1234567890" };
		...
		{
			var item = new Component { Id = "1234567890" };
			var item2 = new Component { Id = "0987654321" };
		...
		{
			var item = new Component { Name = "Foo" };
			var item2 = new Component { Name = "Bar" };
		...
		{
			var item = new Component { Name = "Foo" };
			var item2 = new Component { Name = "Foo" };
		...
		{
			var item = new Component { Name = "Foo" };
			var item2 = new Component { Id = "1234567890", Name = "Foo" };
