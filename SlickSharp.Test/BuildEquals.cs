...
{
	[TestClass]
	public sealed class BuildEquals
	{
		// ReSharper disable SuspiciousTypeConversion.Global
		// ReSharper disable ConvertToConstant.Local
		[TestMethod]
		public void Is_false_for_non_build_objects()
		{
			var b = new Build { Id = "1234567890" };
		...
		{
			var item = new Build { Id = "1234567890" };
			var item2 = new Build { Id = "1234567890" };
		...
		{
			var item = new Build { Id = "1234567890" };
			var item2 = new Build { Id = "0987654321" };
		...
		{
			var item = new Build { Name = "Foo" };
			var item2 = new Build { Name = "Bar" };
		...
		{
			var item = new Build { Name = "Foo" };
			var item2 = new Build { Id = "1234567890", Name = "Foo" };
