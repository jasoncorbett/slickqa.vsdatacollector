...
{
	[TestClass]
	public sealed class TestPlanEquals
	{
		// ReSharper disable SuspiciousTypeConversion.Global
		// ReSharper disable ConvertToConstant.Local
		[TestMethod]
		public void Is_false_for_non_testplan_objects()
		{
			var b = new TestPlan { Id = "1234567890" };
		...
		{
			var item = new TestPlan { Id = "1234567890" };
			var item2 = new TestPlan { Id = "1234567890" };
		...
		{
			var item = new TestPlan { Id = "1234567890" };
			var item2 = new TestPlan { Id = "0987654321" };
		...
		{
			var item = new TestPlan { Name = "Foo" };
			var item2 = new TestPlan { Name = "Bar" };
		...
		{
			var item = new TestPlan { Name = "Foo" };
			var item2 = new TestPlan { Name = "Foo" };
		...
		{
			var item = new TestPlan { Name = "Foo" };
			var item2 = new TestPlan { Id = "1234567890", Name = "Foo" };
