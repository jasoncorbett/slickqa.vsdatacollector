...
namespace SlickQA.SlickSharp.Test.Web
{
	...
	public sealed class SelectGetApi
	{
		...
		{
			var d = new DummyObjectWithFields
			        {
			        	Id = "0123456789abcdefABCDEF",
						Name = "Dummy Object"
			        };

			var expectedPath = "/0123456789abcdefABCDEF";

			var actualPath = UriBuilder.SelectGetApi(d);
		...
		public void Bypasses_apis_for_which_the_field_has_the_default_value()
		{
			...
			var expectedPath = "byname/Dummy Object";
		...
		{
			var d = new DummyObjectWithProperties
			{
				Id = "0123456789abcdefABCDEF",
				Name = "Dummy Object"
			};
