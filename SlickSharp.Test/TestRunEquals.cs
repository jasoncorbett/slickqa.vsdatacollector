...
{
	[TestClass]
	public sealed class TestRunEquals
	{
		// ReSharper disable SuspiciousTypeConversion.Global
		// ReSharper disable ConvertToConstant.Local
		[TestMethod]
		public void Is_false_for_non_testrun_objects()
		{
			var b = new TestRun { Id = "1234567890" };
		...
		{
			var item = new TestRun { Id = "1234567890" };
			var item2 = new TestRun { Id = "1234567890" };
		...
		{
			var item = new TestRun { Id = "1234567890" };
			var item2 = new TestRun { Id = "0987654321" };
		...
		{
			var item = new TestRun { Name = "Foo" };
			var item2 = new TestRun { Name = "Bar" };
		...
		{
			var item = new TestRun { Name = "Foo" };
			var item2 = new TestRun { Name = "Foo" };
		...
		{
			var item = new TestRun { Name = "Foo" };
			var item2 = new TestRun { Id = "1234567890", Name = "Foo" };
