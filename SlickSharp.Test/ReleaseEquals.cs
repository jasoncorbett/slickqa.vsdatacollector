...
{
	[TestClass]
	public sealed class ReleaseEquals
	{
		// ReSharper disable SuspiciousTypeConversion.Global
		// ReSharper disable ConvertToConstant.Local
		[TestMethod]
		public void Is_false_for_non_release_objects()
		{
			var b = new Release { Id = "1234567890" };
		...
		{
			var item = new Release { Id = "1234567890" };
			var item2 = new Release { Id = "1234567890" };
		...
		{
			var item = new Release { Id = "1234567890" };
			var item2 = new Release { Id = "0987654321" };
		...
		{
			var item = new Release { Name = "Foo" };
			var item2 = new Release { Name = "Bar" };
		...
		{
			var item = new Release { Name = "Foo" };
			var item2 = new Release { Name = "Foo" };
		...
		{
			var item = new Release { Name = "Foo" };
			var item2 = new Release { Id = "1234567890", Name = "Foo" };
